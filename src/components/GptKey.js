...
import { addKey } from '../utils/gptSlice';
    ...
    return (
        <div>
            <form action="" className='text-center' onSubmit={e => e.preventDefault()}>
                <input type="text" ref={keyText} className='bg-slate-800 sm:w-3/4 w-11/12 text-gray-50 px-4 py-2 mt-4 rounded-s-full rounded-e-full border-cyan-600 border-2 caret-cyan-500 ' placeholder="Enter your openai api key" />
